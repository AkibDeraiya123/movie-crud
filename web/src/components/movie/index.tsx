        ...
        <div className="p-4">
            {isLoading ? (
                ...
                <div className="text-center h-full flex justify-center items-center flex-col min-h-[75vh]">
                    <p className='text-4xl font-semibold text-white'>Your movie list is empty.</p>
                    ...
                    <div className="flex justify-between items-center py-14 px-2">
                        <Link href='/movie/create'>
                            <div className="text-2xl flex items-center gap-2">
                                ...
                                <FaPlus className='border rounded-full font-semibold text-white p-1 font-bold' />
                            </div>
                        </Link>
                        <div className="flex items-center gap-2 cursor-pointer" onClick={handleLogout}>
                            <p className='font-semibold capitalize text-white'>logout</p>
...
const SingleMovieItem: React.FC<{ movie: IMovie }> = ({ movie }) => {
    return (
        <div
            key={movie._id}
            className="flex flex-col gap-2 p-4 w-full shadow-md rounded-lg bg-[#092C39]"
        >
            ...
            <div className="flex justify-between items-center">
                <h3 className="text-lg truncate capitalize text-white">{movie.title}</h3>
